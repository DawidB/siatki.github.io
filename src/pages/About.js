  ...
  const values = [
    {
      ...
      title: 'Jakość',
      description:
        'Używamy tylko sprawdzonych materiałów najwyższej jakości od renomowanych producentów.',
    },
    {
      icon: '🤝',
      title: 'Zaufanie',
      description:
        'Budujemy długoterminowe relacje z klientami oparte na uczciwości i transparentności.',
    },
    {
      icon: '⚡',
      title: 'Terminowość',
        ...
        <div className='container'>
          <div className='mission-vision-grid'>
            <div className='mission-box'>
              ...
              <h2>Nasza Misja</h2>
              <p>
                Naszą misją jest dostarczanie najwyższej jakości ogrodzeń, które łączą
                funkcjonalność, estetykę i trwałość. Dążymy do tego, aby każdy klient czuł się
                bezpiecznie i zadowolony z naszych usług. Stawiamy na profesjonalizm, uczciwość i
                terminowość w każdym projekcie.
              </p>
            </div>
            <div className='vision-box'>
              ...
              <h2>Nasza Wizja</h2>
              <p>
                Chcemy być najbardziej zaufaną firmą ogrodzeniową w Polsce, rozpoznawalną za
                innowacyjne podejście, doskonałą obsługę klienta i niezawodność. Dążymy do ciągłego
                rozwoju, wprowadzania nowoczesnych rozwiązań i budowania długoterminowych relacji z
                klientami.
              </p>
            </div>
          </div>
      ...
      <section className='section team-section'>
        <div className='container'>
          ...
          <div className='team-description'>
            <p>
              Nasz zespół składa się z doświadczonych monterów, projektantów i konsultantów, którzy
              łączą wiedzę techniczną z pasją do swojej pracy. Regularnie uczestniczą w szkoleniach
              i certyfikacjach, aby zapewnić najwyższą jakość usług.
            </p>
            <p>
